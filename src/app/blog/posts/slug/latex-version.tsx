  ...
  return (
    <article className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 prose prose-lg prose-gray dark:prose-invert">
      ...
      <section>
        ...
        <p>
          Assuming <LaTeX math="X^\top X" /> is invertible, we obtain:
        </div>
        <div className="text-center mt-4 mb-4">
        ...
        <p>
          This formulation assumes that the errors follow a normal distribution with mean 0 and variance <LaTeX math="\sigma^2" />.
        </p>
